...
| 功能 | 1.21.1 |
| --- | --- |
| Fabric API 支持 | [Fabric API](https://modrinth.com/mod/fabric-api) |
| Kotlin 运行时 | [Fabric Language Kotlin](https://modrinth.com/mod/fabric-language-kotlin) |
...
| 功能 | 1.21.1 | 可选替代 |
| --- | --- | --- |
| 渲染引擎优化 | [Sodium](https://modrinth.com/mod/sodium) |  |
| 游戏逻辑优化 | [Lithium](https://modrinth.com/mod/lithium) |  |
